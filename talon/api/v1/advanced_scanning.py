...
web_scan_request = api.model(
    "WebScanRequest",
    {
        "target_url": fields.String(required=True, description="Target URL to scan"),
        "scan_type": fields.String(
            description="Scan type: comprehensive, quick, targeted", default="comprehensive"
        ),
...
container_scan_request = api.model(
...
secrets_scan_request = api.model(
    "SecretsScanRequest",
    {
...
threat_intel_request = api.model(
    "ThreatIntelRequest",
    {
...
class BulkThreatIntelResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            results = {
                cve_id: {"cve_id": cve_id, "exploitation_status": "UNKNOWN"} for cve_id in cve_ids
            }
